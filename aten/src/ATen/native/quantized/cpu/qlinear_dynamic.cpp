...
template <bool ReluFused>
at::Tensor PackedLinearWeightsMkldnn::apply_dynamic_impl(
    at::Tensor input,
    bool reduce_range) {
...
at::Tensor PackedLinearWeightsMkldnn::apply_dynamic(
    at::Tensor input,
    bool reduce_range) {
  return apply_dynamic_impl</*ReluFused=*/false>(
      std::move(input), reduce_range);
...
at::Tensor PackedLinearWeightsMkldnn::apply_dynamic_relu(
    at::Tensor input,
    bool reduce_range) {
